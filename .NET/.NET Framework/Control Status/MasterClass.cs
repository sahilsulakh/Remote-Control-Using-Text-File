...
namespace App1Framework
{
    public class MasterClass : IDisposable
    {
        private const string ControlFileUrl =
            "https://keymaster-agni.vercel.app/api/vault/ellRHrNSMrcAvtnKsvHVqyOvgbT2/control.txt";
        ...
        private bool _maintenanceMessageShown = false;
        ...
        private void ApplyStatus(string status)
        {
            ...
            {
                case "STOPPED":
                    MessageBox.Show("This application is currently out of service. Please try again later.",
                                    "Application Stopped",
                ...
                case "PAUSED":
                    ...
                    {
                        MessageBox.Show("The application is currently under maintenance. Please try again later.",
                                        "Maintenance Mode",
                                        MessageBoxButtons.OK,
        ...
        {
            ToggleRecursive(_mainForm, enabled);
        }
